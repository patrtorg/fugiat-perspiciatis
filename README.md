[![npm](https://img.shields.io/npm/v/@patrtorg/fugiat-perspiciatis.svg)](https://www.npmjs.com/package/@patrtorg/fugiat-perspiciatis) ![downloads](https://img.shields.io/npm/dt/@patrtorg/fugiat-perspiciatis.svg) [![CI](https://github.com/patrtorg/fugiat-perspiciatis/actions/workflows/ci.yml/badge.svg)](https://github.com/patrtorg/fugiat-perspiciatis/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@patrtorg/fugiat-perspiciatis/renderer](https://www.npmjs.com/package/@@patrtorg/fugiat-perspiciatis/renderer).

## tl;dr

- Install by executing `npm install @patrtorg/fugiat-perspiciatis` or `yarn add @patrtorg/fugiat-perspiciatis`.
- Import by adding `import { Document } from '@patrtorg/fugiat-perspiciatis'`.
...
[Online demo](https://projects.wojtekmaj.pl/@patrtorg/fugiat-perspiciatis/) is also available!
...
- [v7.x](https://github.com/patrtorg/fugiat-perspiciatis/blob/v7.x/packages/@patrtorg/fugiat-perspiciatis/README.md)
- [v6.x](https://github.com/patrtorg/fugiat-perspiciatis/blob/v6.x/README.md)
- [v5.x](https://github.com/patrtorg/fugiat-perspiciatis/blob/v5.x/README.md)
- [v4.x](https://github.com/patrtorg/fugiat-perspiciatis/blob/v4.x/README.md)
- [v3.x](https://github.com/patrtorg/fugiat-perspiciatis/blob/v3.x/README.md)
- [v2.x](https://github.com/patrtorg/fugiat-perspiciatis/blob/v2.x/README.md)
- [v1.x](https://github.com/patrtorg/fugiat-perspiciatis/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @patrtorg/fugiat-perspiciatis` or `yarn add @patrtorg/fugiat-perspiciatis`.
...
```ts
import { pdfjs } from '@patrtorg/fugiat-perspiciatis';
...
import { Document, Page } from '@patrtorg/fugiat-perspiciatis';
...
Check the [sample directory](https://github.com/patrtorg/fugiat-perspiciatis/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/patrtorg/fugiat-perspiciatis/wiki/Recipes) in [React-PDF Wiki](https://github.com/patrtorg/fugiat-perspiciatis/wiki/).
...
```ts
import '@patrtorg/fugiat-perspiciatis/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@patrtorg/fugiat-perspiciatis/dist/Page/TextLayer.css';
```
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@patrtorg/fugiat-perspiciatis__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@patrtorg/fugiat-perspiciatis__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@patrtorg/fugiat-perspiciatis__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@patrtorg/fugiat-perspiciatis__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/patrtorg/fugiat-perspiciatis/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@patrtorg/fugiat-perspiciatis-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@patrtorg/fugiat-perspiciatis-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@patrtorg/fugiat-perspiciatis-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@patrtorg/fugiat-perspiciatis-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@patrtorg/fugiat-perspiciatis-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@patrtorg/fugiat-perspiciatis-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@patrtorg/fugiat-perspiciatis/contributors.svg?width=890&button=false)
